...
interface BlockProps {
  ...
  number: string;
  unit: string;
  percentage?: number; // Make percentage prop optional
}
...
const TodaysHighlights: React.FC = () => {
  return (
    <StyledTodaysHighlights>
      ...
      <Content>
        <Block blocktype="wsv" header="Wind status" number="7" unit="mph" />
        <Block
        ...
        <Block
          ...
          unit="miles"
        />
        <Block blocktype="empty" header="Air Pressure" number="998" unit="mb" />
      </Content>
